...
extension String {
    func swapPlaceholders(userName: String?, charName: String?, userSettings: UserSettings) -> String {
        replacingOccurrences(of: "{{user}}", with: userName ?? userSettings.defaultUserName)
